<template>
  <div style="height:100%">
    ...
    <div id="alerttypetrend" style="min-height:300px;height:90%"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      ...
      var myChart = echarts.init(document.getElementById("alerttypetrend"));
      ...
      myChart.setOption({
        ...
        series: [
          ...
          },
          {
            type: "line",
            itemStyle: {
              color: "rgb(139, 126, 232)"
            },
            lineStyle: {
              color: "rgba(139, 126, 232,0)"
            },
            symbol: "emptyCircle",
            // smooth: true,
            data: [120, 185, 280, 34, 220, 30, 100],
            areaStyle: {
              color: {
                type: "linear",
                x: 0,
                ...
                colorStops: [
                  {
                    offset: 0,
                    color: "rgba(139, 126, 232, 0.8)" // 0% 处的颜色
                  },
                  {
                    offset: 1,
                    color: "rgba(139, 126, 232, 0.1)" // bottom 处的颜色
                  }
                ],
                globalCoord: false // 缺省为 false
              }
